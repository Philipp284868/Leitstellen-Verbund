...
Abschließender Lauf: 4.380,6 ms Gestendauer, 228 erfasste Frames, Median 18,1 ms, 95. Perzentil 36,2 ms, zwölf Frames über 33 ms und 4.316 SVG-Elemente. Das entspricht über die Geste ungefähr 52 erfassten Frames pro Sekunde. Die Zielmarke von durchgehend 60 fps wurde in diesem Lastlauf nicht erreicht. Andere Probeläufe lagen bei einem Median von 12,1 ms und einem 95. Perzentil von 24,3 ms; diese günstigeren Werte ersetzen nicht den abschließenden Messdatensatz.
...
Die Wiki-Quellen einschließlich Rivermere-Seite und Navigation wurden unter `docs/wiki/` erweitert. Das separate GitHub-Wiki-Repository liefert weiterhin „Repository not found“; die erste Wiki-Seite ist noch nicht initialisiert. Die Online-Wiki-Aktualisierung ist deshalb nicht als erledigt ausgewiesen. Frühere offene Wiki-/Projects-Punkte bleiben bestehen und werden durch diesen Kartenauftrag nicht geschlossen.
