...
Noch nicht online: Wiki-Inhalte liegen vollständig in docs/wiki; die erste Wiki-Seite muss in einer angemeldeten GitHub-Sitzung initialisiert werden. ProjectsV2 ist wegen fehlendem project-/read:project-Zugriff blockiert. [Wiki-Nachweis](WIKI-VEROEFFENTLICHUNG.md) und [Project-Konfiguration/Zugriffsfehler](PROJECT-EINRICHTUNG.md). Diese zwei Einrichtungsschritte bleiben in #22 offen.
