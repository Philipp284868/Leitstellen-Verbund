...
Für den Einstieg gilt eine Ausnahme von den Lagefaktoren: Solange weniger als drei Einsätze abgeschlossen sind oder der einsatzfähige Wachenbestand weniger als drei Fahrzeuge umfasst, beträgt das Grundintervall fünf bis acht Minuten. Nacht, ruhige Lage und Erholung verlängern es nicht zusätzlich; Sturm beschleunigt es nicht. Die ersten drei Einsätze erlauben höchstens einen offenen Einsatz und einen wartenden Anruf. Ohne alarmierbares Fahrzeug oder bei erreichter Lastgrenze wartet die Erzeugung weiterhin. Danach gelten die bestehenden Flotten-, Warte- und Belastungsgrenzen. Verpasste Generierungsintervalle werden nicht als nachträgliche Anrufwelle ausgespielt; ein Zeitsprung wird auf vier Stunden begrenzt.

Die gespeicherte Notrufplanung wird einmalig von Version 1 auf 2 übernommen. Bei kleinen oder neuen Leitstellen wird eine überlange verbleibende Frist auf das neue Intervall verkürzt. Kürzere Fristen und der Zufallsstand bleiben erhalten. Dafür ist kein neues SQLite-Schema und kein Zurücksetzen eines Spielstandes erforderlich.
