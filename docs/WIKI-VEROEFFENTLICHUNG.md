...
Die [öffentliche Wiki](https://github.com/Philipp284868/Leitstellen-Verbund/wiki) ist erreichbar. Wiki-Commit: `71a2906` (Initialisierung: `d9e3538`). Der frühere Fehler „Repository not found“ ist behoben. Wiki-Veröffentlichung ändert weder Spielcode noch Produktivserver. Die fehlenden ProjectsV2-API-Rechte sind ein separater offener Punkt in Issue #22.
