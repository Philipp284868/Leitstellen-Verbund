...
Sicherung: `node dist/server/cli.js backup`. Wiederherstellung nur bei gestopptem Server nach der dokumentierten CLI-Anleitung; Sitzungen werden dabei widerrufen. Vor notwendigen Schemaänderungen wird automatisch ein Vorabbackup angelegt. Schema 11 bleibt bei 2.14 erhalten.
