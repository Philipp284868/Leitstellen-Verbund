...
Falkenried-Daten bleiben als geschützter Bestand erhalten und werden beim Rivermere-Start abgewiesen; Wachen und laufende Fahrten werden nicht auf die andere Geografie verschoben. War bisher Falkenried aktiv, benötigt der Betreiber für Rivermere ein eigenes persistentes Datenverzeichnis. Das Update 2.21 migriert bestehendes Rivermere auf Schema 14 mit Euro-Bestandsschutz und automatischer Wachbesetzung, ohne Geografie oder XP umzudeuten; siehe [[Serverbetrieb]]. Konten, Besitz und laufende Vorgänge werden beim Wechsel nach Deutschland nicht automatisch übertragen.
