...
1. Beide Konten wählen im Hauptmenü Multiplayer.
2. Der Inhaber öffnet **Freunde**, trägt den bestehenden Benutzernamen ein und klickt **Disponenten einladen**.
3. Das andere Konto öffnet **Freunde** und nimmt die Einladung ausdrücklich an.
...
Der bisherige persönliche Multiplayerstand des beitretenden Kontos bleibt separat gespeichert und wird beim Verlassen wieder angezeigt. Sein Einzelspielerstand bleibt privat und unverändert zugeordnet. Leitstellenmitgliedschaft gewährt keine Kontoverwaltung und keine Serverrechte. Nur der Inhaber lädt ein oder entfernt andere Mitglieder; Mitglieder können selbst austreten. Offene Einladungen können zurückgezogen werden.
...
[Bedienung](SPIELANLEITUNG.md) · [Phase 1 und Migration](PHASE-1.md) · [AMP und Sicherungen](AMP.md)
