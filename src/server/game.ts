...
} from "../simulation/civil-protection-schema";
import { civilProtectionCommand } from "../simulation/civil-protection";
import { diagnostics } from "./diagnostics";
import {
  callGenerationAllowed,
  withCallGeneration,
} from "../simulation/call-generation";
import { mulRatio } from "../shared/money";
import { ensureWorldSituation, stepWorldSituation } from "./world-situation";
import { advanceSituation } from "../simulation/world-situation";
import { repairIncidentLocations } from "../simulation/location-repair";
...
import {
  ...
  retryCallLater,
} from "../simulation/pacing";
import { majorActions, type MajorAction } from "../simulation/major-schema";
import { majorCommand } from "../simulation/major-command";
import { maybeMajor, campaignTick } from "../simulation/major-incidents";
...
import { attachDynamics, followupsTick } from "../simulation/dynamics";
...
import { parseMode, type GameMode } from "../shared/mode";
