...
Seit der Kartenumstellung wird ausschließlich Rivermere ausgeliefert. AMP und npm start verwenden weiterhin dist/server/index.js. Bestehende Rivermere-Spielstände bleiben erhalten; alte Falkenried-Daten werden geschützt abgewiesen. Details: [Rivermere-Betrieb](docs/RIVERMERE.md).
