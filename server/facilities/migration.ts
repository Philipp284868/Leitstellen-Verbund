...
import type { Facility, FacilityCatalog } from "../../src/facilities/types";
import { meters, unproject } from "../../src/germany/projection";
import { validate, type Building } from "../../src/model";
