...
## 2.30.0 · Reale Wachprofile, verbindlicher Rückruf und integrierte Spielerhilfe · 14.09.2026

- Reale FF, BF, belegte hauptamtliche FF-Anteile, BF-/FF-Gemeinschaftsstandorte und unterstützte Spezialwachen erhalten quellgebundene Profile. Ein versioniertes Zusatzpaket wertet den vorhandenen Deutschlandkatalog aus; ungeklärte Standorte bleiben ausdrücklich ungeklärt. Neue Kaufangebote zeigen Typ, abstrahierte Kapazität, Bereitschaft und den verbindlichen Profilpreis. Eine FF wird nicht frei zur BF umgewandelt.
- Endliche Spielbesatzungen verwenden das vorhandene Freiwilligen-, Dienst- und Anfahrtsmodell. Bereits anwesende Kräfte bleiben berücksichtigt; belegte Gemeinschaftsstandorte werden nur einmal verkauft. Einstiegssuche nach freien FF, abgestufte neue Wachpreise und unveränderte Fahrzeugpreise, Einnahmen, Startgeld und XP. [Quellen, Datenlücken und Profile](docs/WACHPROFILE.md).
- Eigene und ausdrücklich verwaltete Fahrzeuge können trotz offener Erkundung, Nachforderung oder Führungsbindung zurückgerufen werden. Konkrete Warnungen erläutern die Folgen. Patiententransporte erhalten einen Folgeauftrag zur Wache nach der echten Klinikübergabe; Defekte und Routingausfälle behalten einen persistenten, kontrolliert wiederholten Rückkehrauftrag. Mehrfachabzug liefert Ergebnisse je Fahrzeug und gibt Szenenaufgaben erst beim tatsächlichen Lösen frei.
- Erfolg, fachlich begründeter Fehlschlag und bewusste berechtigte Einsatzaufgabe sind getrennte persistente Ergebnisse mit Grund, Zeitpunkt und Urheber. Offene Szenen erhalten eine begrenzte dokumentierte externe Übernahme; echte laufende Transporte bleiben gebunden und zählen weiterhin zur Arbeitslast. Technische Störungen sind keine Niederlage; aufgegebene/fehlgeschlagene Einsätze erhalten keine Erfolgsvergütung.
- Support führt unmittelbar zu Gaminglive-Discord. Die integrierte lokale Wiki bietet freigegebene Spielerhilfe, Suche, interne Links und Tastaturbedienung im Hauptmenü und HUD. Shop bleibt sichtbar mit „Demnächst“ deaktiviert. Datenschutz steht dauerhaft nur unten rechts im Hauptmenü und ist ohne Anmeldung unter `/datenschutz` erreichbar. Fehlerberichte bestätigen eine Berichtsnummer ohne privaten GitHub-Link.
- Schema 29 erstellt vor der Profilübernahme ein Backup, erhält historische Kaufbelege und aktive Besatzungen und wendet geprüfte Korrekturen wiederholungssicher an. Neue Profilstände haben eine eigene Revisionsprüfung, auch nach der vorgeschalteten AMP-SQL-Migration. Kein Reset und keine nachträglichen Kaufpreisforderungen.
- Übergang zum privaten AMP-Paketweg: geschützte Zugangsdaten-Datei, begrenzte authentifizierte GitHub-Downloads ohne Tokenweitergabe an Asset-Hosts, vollständige Paketprüfung vor dem eigenen Prozessstopp und lokale AMP-Vorlagen. Die tatsächliche Privatumschaltung und Zugangseinrichtung sind separate Betriebsschritte und werden durch diesen Codeeintrag nicht als ausgeführt behauptet. [Einrichtung und Prüfweg](docs/PRIVATER-AMP-UPDATEWEG.md).
